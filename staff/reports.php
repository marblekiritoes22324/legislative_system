        ...
        <thead style="background-color: #f8fafc; border-bottom: 2px solid #e2e8f0;">
          <tr>
            ...
            <th class="py-3.5 text-center text-uppercase text-dark fw-bold"
              style="font-size: 0.88rem; letter-spacing: 0.03em;">Status</th>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
      ...
      <div class="d-flex align-items-center gap-2">
        <div class="btn-group btn-group-sm p-1 bg-light rounded-pill border shadow-2xs" role="group">
          ...
          <button type="button" class="btn btn-sm rounded-pill px-3 py-1 text-secondary" id="filterStaffReportVersion"
            style="background:transparent;" onclick="filterStaffReportsTable('Version', this)">Versions</button>
        </div>
      </div>
    </div>
