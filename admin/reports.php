  ...
  <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
    ...
    <div class="table-responsive border rounded-4 overflow-hidden mb-2">
      <table class="table table-hover align-middle mb-0" style="font-size:0.88rem;">
        <thead style="background-color: #f8fafc; border-bottom: 2px solid #e2e8f0;">
          <tr>
            <th class="py-3 px-3 text-uppercase text-dark fw-bold"
            ...
            <th class="py-3 px-3 text-uppercase text-dark fw-bold text-nowrap"
              style="font-size: 0.88rem; letter-spacing: 0.03em; color: #000000 !important; width: 140px;">Type</th>
            <th class="py-3 px-3 text-uppercase text-dark fw-bold text-nowrap"
              style="font-size: 0.88rem; letter-spacing: 0.03em; color: #000000 !important; width: 180px;">Date Generated</th>
            <th class="py-3 px-3 text-end text-uppercase text-dark fw-bold text-nowrap"
              style="font-size: 0.88rem; letter-spacing: 0.03em; color: #000000 !important; width: 160px;">Action</th>
          </tr>
        </thead>
