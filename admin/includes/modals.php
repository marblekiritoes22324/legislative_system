  ...
  <div class="modal fade" id="aiSummarizerModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 820px;">
      <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden" style="background-color: #ffffff;">
        ...
        <div class="modal-body px-4 px-md-5 pb-4 pt-0" id="aiReportPrintableArea" style="max-height: 80vh; overflow-y: auto;">

          <!-- Loading State -->
          <div id="aiSummaryLoading" class="text-center py-5" style="display:none;">
            <div class="d-inline-flex align-items-center justify-content-center mb-3">
              <button id="aiAnalyzingStatusBtn" class="btn btn-primary rounded-4 py-2 px-4 fw-semibold text-white shadow-sm border-0" disabled style="background-color: #3b82f6;">
                <i id="aiAnalyzingStatusIcon" class="bi bi-arrow-repeat spin me-2" style="font-size:1.1rem;"></i><span id="aiAnalyzingStatusText">Analyzing...</span>
              </button>
            </div>
            <div class="fw-semibold text-dark fs-5 mt-2">Gemini AI is reading and analyzing document...</div>
            <p class="text-muted small mb-0">Extracting executive summary, policy impact, and legislative recommendations.</p>
          </div>
          ...
          <div id="aiSummaryContent" style="display:none; font-family: 'Times New Roman', Times, serif; color: #1a1a1a;">
            ...
            <div class="text-center mb-4">
              <div class="d-flex align-items-center justify-content-center gap-3 mb-2">
                <img src="../assets/images/manilacityhall.svg" alt="Manila Seal" style="width: 70px; height: 70px; object-fit: contain;">
                <div>
                  <h4 class="fw-bold mb-0 text-uppercase" style="letter-spacing: 2px; font-size: 1.35rem; color: #000;">MANILA CITY HALL</h4>
                  <div class="fw-bold text-uppercase text-secondary" style="font-size: 0.85rem; letter-spacing: 1.5px;">OFFICE OF THE CITY COUNCIL</div>
                </div>
              </div>
            ...
            <div class="mb-4">
              <div class="d-flex align-items-center gap-2 mb-3">
                ...
                <h5 class="fw-bold text-uppercase mb-0" style="font-size: 0.95rem; letter-spacing: 1px;">DOCUMENT INFORMATION</h5>
              </div>
              ...
              <div class="ps-4" style="font-size: 0.95rem; line-height: 1.8;">
                <div class="row mb-1">
                  ...
                  <div class="col-7 col-sm-8 fw-semibold text-dark" id="aiSum_title">Flood Risk Assessment and Drainage Improvement Plan for Manila City</div>
                </div>
                <div class="row mb-1">
            ...
            <div class="mb-4">
              <div class="d-flex align-items-center gap-2 mb-2">
                ...
                <h5 class="fw-bold text-uppercase mb-0" style="font-size: 0.95rem; letter-spacing: 1px;">EXECUTIVE SUMMARY</h5>
              </div>
              <p class="ps-4 mb-0 text-dark" id="aiSum_summary" style="font-size: 0.95rem; line-height: 1.7; text-align: justify;">
                This document evaluates the growing frequency of urban flooding in Manila City using field assessments, rainfall records, and community surveys. It identifies major vulnerabilities within the city's drainage network and outlines strategic infrastructure and management solutions. Implementing these proposals aims to reduce flood risks and safeguard public safety and local infrastructure.
              </p>
            </div>
            <hr style="border-color: #d1d5db; opacity: 0.7;" class="my-4">
            ...
            <div class="mb-4">
              ...
              <div class="ps-4 text-dark" id="aiSum_findings" style="font-size: 0.95rem; line-height: 1.7;">
                <ul class="mb-0 ps-3">
                  <li class="mb-1">Clogged drainage systems severely restrict water flow during heavy rainfall events.</li>
                  <li class="mb-1">Existing pumping stations are inadequate to manage high volumes of storm run-off across districts.</li>
                  <li class="mb-1">Improper waste disposal practices exacerbate the blockages in urban drainage channels.</li>
                  <li class="mb-1">Aging and outdated drainage infrastructure heavily contributes to recurring localized flooding.</li>
                </ul>
              </div>
            </div>
            <hr style="border-color: #d1d5db; opacity: 0.7;" class="my-4">
            ...
            <div class="mb-4">
              <div class="d-flex align-items-center gap-2 mb-2">
                ...
                <h5 class="fw-bold text-uppercase mb-0" style="font-size: 0.95rem; letter-spacing: 1px;">POLICY IMPACT</h5>
              </div>
              <p class="ps-4 mb-0 text-dark" id="aiSum_impact" style="font-size: 0.95rem; line-height: 1.7;">
                Enforcing stricter waste management regulations alongside drainage modernization will strengthen Manila's disaster resilience and protect critical public assets.
              </p>
            </div>
            <hr style="border-color: #d1d5db; opacity: 0.7;" class="my-4">
            ...
            <div class="mb-4">
              ...
              <p class="ps-4 mb-0 text-dark" id="aiSum_recommendation" style="font-size: 0.95rem; line-height: 1.7;">
                The proposed strategy focuses on drainage rehabilitation, pumping station expansion, smart flood monitoring, and policy enforcement to minimize economic losses and ensure public safety during the rainy season.
              </p>
            </div>
            <hr style="border-color: #d1d5db; opacity: 0.7;" class="my-4">

            <!-- SECTION 7: ORIGINAL DOCUMENT -->
            <div class="mb-2">
              <div class="d-flex align-items-center gap-2 mb-2">
                <i class="bi bi-paperclip fs-5 text-dark"></i>
                <h5 class="fw-bold text-uppercase mb-0" style="font-size: 0.95rem; letter-spacing: 1px;">ORIGINAL DOCUMENT</h5>
              </div>
              <div class="ps-4">
                <a id="aiSum_doclink" href="#" target="_blank" class="btn btn-outline-secondary btn-sm rounded-3 px-3 py-2 fw-semibold d-inline-flex align-items-center gap-2" style="font-family: sans-serif; font-size: 0.85rem;">
        ...
        <div class="modal-footer bg-white border-top px-4 py-3 justify-content-between">
          ...
          <div class="d-flex align-items-center gap-2" style="font-family: sans-serif;">
            <button type="button" class="btn btn-dark fw-semibold px-3 py-2 rounded-3 d-flex align-items-center gap-2" onclick="downloadAiReport()">
        ...
        <div class="modal-body p-4" style="max-height: 70vh; overflow-y: auto;">
          <div class="row g-3">
            <div class="col-md-12">
              ...
              <input type="text" name="title" class="form-control" placeholder="Enter the policy or research title" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6 d-flex align-items-end">
              ...
              <button type="button" class="btn btn-primary fw-semibold rounded-3 w-100" onclick="generateKeywords()"
                id="aiManualBtn"><i class="bi bi-magic me-2"></i>Auto Fill</button>
            </div>
          </div>
        </div>
...
<!-- 3. Data Collection Info Modal (replaced fake upload — data syncs from Policy Research) -->
      ...
      <div class="modal-body p-4">
        ...
        <p class="text-muted text-center mb-3">
          The <strong>Data Collection</strong> table automatically displays all records from <strong>Policy
            Research</strong>.
          No separate upload is needed — any document you upload in Policy Research will instantly appear here.
        </p>
...
<!-- 4. Impact Assessment Modal (Official Document Report Layout) -->
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 820px;">
    <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden" style="background-color: #ffffff;">
      ...
      <div class="modal-body px-4 px-md-5 pb-4 pt-0" style="max-height: 80vh; overflow-y: auto;">
        ...
        <div id="evalReportContent" style="font-family: 'Segoe UI', system-ui, -apple-system, sans-serif; color: #1a1a1a;">
          ...
          <div class="mb-4">
            ...
            <div class="ps-4" style="font-size: 0.95rem; line-height: 1.8;">
              <div class="row mb-1">
                ...
                <div class="col-1 text-center">:</div>
                <div class="col-7 col-sm-8 fw-semibold text-dark" id="evalModalTitle">Flood Risk Assessment and Drainage Improvement Plan for Manila City</div>
              </div>
              <div class="row mb-1">
              ...
              <div class="row mb-1 d-none" id="evalModalApprovedRow">
                <div class="col-4 col-sm-3 fw-bold text-success"><i class="bi bi-patch-check-fill me-1"></i>Approved By</div>
                <div class="col-1 text-center">:</div>
                <div class="col-7 col-sm-8 text-dark fw-medium">
                  <span id="evalModalApprovedBy">Admin</span>
                ...
                <table class="table table-bordered align-middle mb-0" style="font-size: 0.9rem; border-color: #e5e7eb;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="padding: 10px 14px;" class="text-dark" id="evalCriteriaEconomicReason">Funding and implementation costs are manageable and available within municipal allocations.</td>
                    </tr>
                    <tr>
                      <td style="padding: 10px 14px;" class="fw-bold text-dark">Social Impact</td>
                      <td style="padding: 10px 14px;" class="text-dark" id="evalCriteriaSocialReason">The policy provides measurable benefits to affected communities and enhances public welfare.</td>
                    </tr>
                    <tr>
                      <td style="padding: 10px 14px;" class="fw-bold text-dark">Environmental Impact</td>
                      <td style="padding: 10px 14px;" class="text-dark" id="evalCriteriaEnvReason">The policy satisfies urban environmental standards and sustainability requirements.</td>
                    </tr>
                    <tr>
                      <td style="padding: 10px 14px;" class="fw-bold text-dark">Legal Compliance</td>
                      <td style="padding: 10px 14px;" class="text-dark" id="evalCriteriaLegalReason">Compliant with the Local Government Code and relevant national/local statutory frameworks.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div class="mb-4">
            ...
            <div class="ps-4">
              <p class="mb-0 text-dark" id="evalModalAnalysis" style="font-size: 0.95rem; line-height: 1.7; text-align: justify;">
          ...
          <div class="mb-4">
            ...
            <div class="ps-4">
              <div class="mb-2">
                <span id="evalModalRecommendationType" style="display:inline-block;background:#d1fae5;color:#065f46;border:1px solid #a7f3d0;padding:3px 12px;border-radius:999px;font-size:0.8rem;font-weight:600;">Proceed with Implementation</span>
              </div>
              <h6 class="fw-bold text-dark mb-2" id="evalModalRecommendationTitle" style="font-size: 1rem; line-height: 1.4;">
                Enact Policy with Enhanced Inter-Agency Coordination and Funding Frameworks
              </h6>
              <p class="text-dark mb-0" id="evalModalReason" style="font-size: 0.95rem; line-height: 1.7; text-align: justify;">
                The plan addresses a fundamental vulnerability in Manila's urban infrastructure that causes recurring economic losses, though its long-term success requires regional watershed integration and sustainable maintenance funding.
              </p>
            </div>
          </div>
          <hr style="border-color: #e5e7eb; opacity: 0.8;" class="my-4">
          ...
          <div class="mb-4">
            ...
            <div class="ps-4">
              <div class="text-dark" id="evalModalImprovements" style="font-size: 0.95rem; line-height: 1.7;">
                <ul class="mb-0 ps-3">
                  <li class="mb-2">Incorporate nature-based infrastructure solutions, such as bioswales and permeable pavements, alongside traditional engineering upgrades.</li>
                  <li class="mb-2">Establish a formal joint task force with adjacent Metro Manila local government units to address cross-boundary stormwater flow.</li>
                  <li class="mb-0">Develop a multi-year dedicated maintenance fund and real-time public asset management dashboard to ensure operational longevity.</li>
                </ul>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="changeAdminPasswordModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" style="max-width: 500px;">
    <div class="modal-content border-0 shadow rounded-4">
      ...
      <form onsubmit="alert('Administrator password updated successfully!'); bootstrap.Modal.getInstance(this.closest('.modal')).hide(); return false;">
        <div class="modal-body p-4">
          <div class="row g-3">
            <div class="col-md-12">
