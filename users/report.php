  ...
  function renderUserRecentGeneratedReportsTable() {
    ...
    for (var i = startIdx; i < endIdx; i++) {
      ...
      html += '<tr class="align-middle">' +
        ...
        '<span class="fw-semibold text-dark font-monospace" style="font-size: 0.86rem; word-break: break-all;">' + escapeHtml(r.report_name) + '</span>' +
        '</div>' +
        '</td>' +
        '<td class="py-2.5 px-3 text-dark fw-medium" style="font-size: 0.88rem; word-break: break-word;">' + escapeHtml(r.policy_title) + '</td>' +
