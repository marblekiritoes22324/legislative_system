...
<script>
  ...
  function buildUserReportTemplate(repObj) {
    ...
    return '' +
      ...
      '        <td style="padding:12px 16px; border:1px solid #cbd5e1; font-weight:700; color:#0f172a; font-size:0.92rem;">' + escapeHtml(rep.title || rep.policy_title) + '</td>' +
      '      </tr>' +
      '      <tr>' +
      ...
      '        <td style="padding:12px 16px; border:1px solid #cbd5e1; color:#1e293b;">' + escapeHtml(rep.category || 'General Legislation') + '</td>' +
      '      </tr>' +
      '      <tr>' +
      ...
      '          <span style="background:' + evalRes.bg + '; color:' + evalRes.color + '; border:1px solid ' + evalRes.border + '; padding:4px 12px; border-radius:4px; font-weight:700; font-size:0.82rem; display:inline-block;">' + escapeHtml(evalRes.text) + '</span>' +
      '        </td>' +
      '      </tr>' +
      '      <tr>' +
